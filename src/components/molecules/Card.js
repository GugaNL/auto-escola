...
const StyledMediaDesc = styled.div`
...
export const CardMediaDesc = ({ children }) => (
  <StyledMediaDesc>{children}</StyledMediaDesc>
)

CardMediaDesc.defaultProps = {
  children: undefined,
}

CardMediaDesc.propTypes = {
  children: PropTypes.node,
}
//#endregion
